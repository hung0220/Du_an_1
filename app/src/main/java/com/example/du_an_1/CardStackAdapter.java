...
public class CardStackAdapter extends RecyclerView.Adapter<CardStackAdapter.ViewHolder> {
    ...
    private List<ItemModelDulieu> items;

    public CardStackAdapter(List<ItemModelDulieu> items) {
        this.items = items;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ItemModelDulieu data) {
            Picasso.get()
                    .load(data.getImage())
                    .fit()
                    .centerCrop()
    ...
    public List<ItemModelDulieu> getItems() {
        return items;
    }

    public void setItems(List<ItemModelDulieu> items) {
        this.items = items;
    }
}
